...
class TestDadCogMethods(unittest.TestCase):
    def test_single_quote(self):
        ...
        test_strings = [
            f"I{single_quote}m a normal single quote" for single_quote in single_quotes
        ]

        expected_string = (
            f"Hi a normal single quote, I thought you were <@{test_user}>."
        )
    ...
    def test_punction(self):
        ...
        advanced_test = "Cool! I'm hungry, thirsty, and tired!"
